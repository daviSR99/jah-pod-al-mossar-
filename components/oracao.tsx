...
export default function Oracao() {
  ...
  return (
    ...
    <SectionHeading>Oração para o vosso Almosso🙏</SectionHeading>    
    </div>

      <p className='px-4 py-4 text-2xl font-bold !leading-[1.5] sm:text-2xl
        mb-25 max-w-[50rem] text-center sm:mb-0 text-custom-gray'>
      <span className='font-bold'>O al-mosso aceita</span> <span className='text-custom-purple'> todos </span>
      <span>aqueles que o procuram. Só basta você aceitá-lo em seu <span  className='text-custom-purple'>estômago.</span></span>{" "}
      <span className='font-bold'>Deixe seu agradecimento por ele todo dia com esta pequena oração.</span>
      </p>

     <details>
      <summary className='px-4 py-1 sm:text-2xl font-medium !leading-[1.5] text-xl
        mb-15 max-w-[50rem] text-center sm:mb-0 text-gray-500 italic'>Clique aqui para ver a oração!</summary>
